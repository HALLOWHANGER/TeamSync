...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center px-4 md:px-16 lg:px-24">
      ...
      <h1 className="mt-4 bg-gradient-to-r from-black to-[#748298] bg-clip-text text-center text-4xl/12 font-bold text-transparent">
        Organize teams and assign tasks with ease
      </h1>

      <p className="mt-2 max-w-xl text-center text-base/7 text-gray-700">
        Create and manage projects, tasks and team members with ease, all in one, user-friendly platform.
      </p>
